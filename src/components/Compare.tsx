export default function Compare() {
  ...
  return (
    <section className="relative py-16 md:py-24 lg:py-28 bg-[#FAF6EF] overflow-hidden reveal">
      ...
      <div className="container-x relative">
        ...
        <div className="relative max-w-[980px] mx-auto">
          <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-[#B45309] via-[#EA580C] to-[#F59E0B] opacity-20 blur-xl pointer-events-none" />
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl border border-[--border-strong] bg-white shadow-[0_16px_50px_rgba(15,30,61,0.08)]">
            <div className="grid grid-cols-3 text-center text-[12px] md:text-[15px] font-bold py-4 md:py-5 bg-[#26190F] text-white relative overflow-hidden">
              <div className="absolute inset-0 grid-bg-dark opacity-40 pointer-events-none" />
              <div className="relative text-[#A8A092]">항목</div>
              <div className="relative text-[#D9CFC0]">일반 대출</div>
            ...
            {rows.map(([label, bad, good], i) => (
              <div
                ...
                } hover:bg-[#FFF4E2] transition-colors`}
              >
                ...
                <div className="py-4 md:py-5 px-2">
                  <span className="inline-flex items-center gap-1 font-bold text-[#1E3A8A] break-keep">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                      <circle cx="12" cy="12" r="10" fill="#F9E5C8" />
            ...
            <div className="grid grid-cols-3 text-center text-[12px] md:text-[14px] border-t border-[--border-strong]">
              ...
              <div className="relative py-3 md:py-4 bg-gradient-to-r from-[#B45309] via-[#EA580C] to-[#F59E0B] text-white font-black tracking-wider overflow-hidden">
