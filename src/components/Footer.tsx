export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#1A120C] text-white py-14 md:py-20">
      ...
      <div className="absolute -top-32 left-1/4 w-96 h-96 rounded-full bg-[#92400E] opacity-40 blur-[100px] pointer-events-none" />
      <div className="absolute -bottom-40 right-1/4 w-[420px] h-[420px] rounded-full bg-[#F59E0B] opacity-25 blur-[120px] pointer-events-none" />
      ...
      <div className="container-x relative max-w-[1040px] text-center">
        ...
        <p className="text-[12px] md:text-[15px] text-[#A8A092] mb-8 md:mb-10 break-keep">
          안전하고 빠른 신용카드 · 소액결제 현금화 전문 서비스
        </p>

        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 mb-10 md:mb-12">
          <div className="inline-flex items-center gap-1.5 text-[12px] md:text-[14px] text-[#D9CFC0]">
            <span className="w-1.5 h-1.5 rounded-full bg-[#10B981] animate-pulse-dot" />
            365일 24시간 상담
          </div>
          <div className="w-px h-3 bg-white/15" />
          <div className="text-[12px] md:text-[14px] text-[#D9CFC0]">업계 최고 94% 지급률</div>
          <div className="w-px h-3 bg-white/15" />
          <div className="text-[12px] md:text-[14px] text-[#D9CFC0]">5년간 무사고</div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 text-left max-w-[780px] mx-auto mb-10 md:mb-12">
          <div className="glass-card-dark rounded-2xl p-5 md:p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[11px] md:text-[13px] text-[#A8A092] font-semibold uppercase tracking-wider">연락처</span>
            </div>
          ...
          <div className="glass-card-dark rounded-2xl p-5 md:p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[11px] md:text-[13px] text-[#A8A092] font-semibold uppercase tracking-wider">취급 상품</span>
            </div>
            <div className="text-[13px] md:text-[14px] text-[#D9CFC0] leading-[1.9] break-keep">
        ...
        <div className="pt-6 md:pt-8 border-t border-white/10 max-w-[820px] mx-auto text-left">
          <div className="text-[10px] md:text-[12px] text-[#A8A092] font-bold mb-2 uppercase tracking-wider">금융상품 조건 공시</div>
          <div className="text-[10px] md:text-[12px] text-[#A6988A] leading-[1.9] space-y-1">
        ...
        <div className="text-[11px] md:text-[13px] text-[#8D8073]">&copy; 2026 담페이 (Dampay). All rights reserved.</div>
      </div>
    </footer>
  )
}
