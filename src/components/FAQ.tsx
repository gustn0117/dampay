...
const faqData = [
  {
    q: '담페이는 어떤 방식으로 진행되는 서비스인가요?',
    a: '담페이는 고객님이 보유하신 신용카드 잔여 한도를 정식 매입 시스템을 통해 즉시 자산화하여 현금으로 지급해 드리는 안전한 매입 서비스입니다. 소액결제·정보이용료 한도도 함께 이용 가능합니다.',
  },
  {
  ...
  {
    q: '지급률은 어떻게 되나요?',
    a: '담페이는 업계 최고 수준인 최대 94% 지급률을 보장합니다. 카드사·결제 방식·할부 개월에 따라 지급률이 조정될 수 있으니 상담 시 정확한 금액을 안내드립니다.',
  },
  {
  ...
  {
    q: '법적으로 안전한 업체인가요?',
    a: '담페이는 정식 등록된 사업자로 합법적인 절차에 따라 5년간 무사고로 안전하게 운영하고 있습니다.',
  },
  {
    q: '주말이나 새벽에도 상담 가능한가요?',
    a: '네, 365일 24시간 연중무휴로 운영됩니다. 텔레그램 또는 전화(010-2918-1929)로 언제든 편하게 상담해 주세요.',
  },
  {
      ...
      <div className="container-x relative max-w-[920px]">
        <div className="text-center mb-10 md:mb-14">
          ...
          <h2 className="text-[26px] md:text-[40px] lg:text-[48px] font-black leading-tight break-keep">
            <span className="text-brand-gradient">담페이</span> 이용 FAQ
          </h2>
        </div>
